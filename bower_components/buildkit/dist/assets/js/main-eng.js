...
/*  urlArgs: "bust=" + (new Date()).getTime(), // drop this later..*/
  paths: {
    ...
    page: 'views/page',
    stellar: 'vendor/jquery.stellar/jquery.stellar.min',
    text: 'lib/require/text',
    qtip2: 'vendor/qtip2/jquery.qtip.min',
    fancybox: 'vendor/fancybox/source/jquery.fancybox.pack',
    fancybox_media: 'vendor/fancybox/source/jquery.fancybox-media',
...
//
require(
  ['jquery', 'underscore', 'backbone', 'i18n', 'page', 'lib/helpers'],
  function($, _, Backbone, I18n, PageView) {
